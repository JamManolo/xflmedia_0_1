...
describe User do
  ...
  describe "relationships" do
    ...
    describe " 'user delete' should destroy associations with" do 
    
      it "followed users" do
        @user.follow!(@followed)
        @user.destroy
        @followed.followers.should_not include(@followed)
      end
  ...
  #  end
  #  
  #  it "should have a managers method" do
  #    @user.should respond_to(:managers)
  #  end
  #  
  ...
  describe "owners" do
    ...
    it "should have a owners method" do
